    ...
    <div class="container">
      <div class="navbar-content">
        <a href="#" class="navbar-brand">
          D'Ozono <span>Purificadores</span>
        </a>
              ...
              <div class="col-group col-md-6">
                ...
                <div class="submenu-item">
                  <div class="row">
                    <div class="col-md-6">
                      <ul>
                        <li class="nav-item"><a href="{{ url('/cotizaciones/crear-venta') }}" class="nav-link {{ active_class(['cotizaciones/crear-venta']) }}">De Venta</a></li>
                        <li class="nav-item"><a href="{{ url('/cotizaciones/crear-mantenimiento') }}" class="nav-link {{ active_class(['cotizaciones/crear-mantenimiento']) }}">De Mantenimiento</a></li>
                        <li class="nav-item"><a href="{{ url('/cotizaciones/crear-renta') }}" class="nav-link {{ active_class(['cotizaciones/crear-renta']) }}">De Renta</a></li>
                      </ul>
                    </div>
                  </div>
                </div>
        ...
        <li class="nav-item {{ active_class(['icons/*']) }}">
          ...
          <div class="submenu">
            <ul class="submenu-item">
              ...
              <li class="nav-item"><a href="{{ url('/usuarios1') }}" class="nav-link {{ active_class(['icons/mdi-icons']) }}">Usuarios</a></li>
              <li class="nav-item"><a href="{{ url('/prospectos') }}" class="nav-link {{ active_class(['icons/mdi-icons']) }}">Prospectos</a></li>
              <li class="nav-item"><a href="{{ url('/vendedores') }}" class="nav-link {{ active_class(['icons/mdi-icons']) }}">Vendedores</a></li>
              <li class="nav-item"><a href="{{ url('/medioscaptacion') }}" class="nav-link {{ active_class(['icons/mdi-icons']) }}">Medios de captación</a></li>
