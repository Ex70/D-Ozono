      ...
      <div class="card-body">
        <div class="container-fluid d-flex justify-content-between">
          ...
          <div class="col-lg-4 pe-0" id="datosCotizacion">
              ...
              <script>var folio = "{{$datos['folio']}}";</script>
              <h6 class="text-end mb-4">{{$datos['folio']}}</h6>
              <div class="row mb-3">
              ...
              <input type="hidden" id="tipo" value="Venta">
            ...
            <div class="row mb-3">
              <label for="exampleInputUsername2" class="col-sm-4 col-form-label">Garantía</label>
              <div class="col-sm-8">
                <select class="form-select" id="garantia" name="garantia">
                  <option selected disabled>Seleccione una garantía</option>
        ...
        <div class="container-fluid mt-5 mb-4 w-100">
          <div class="row">
        ...
        <div class="container-fluid row mt-5 mb-4 w-100">
          ...
          <div class="col-lg-10">
            <textarea class="form-control" id="otras_condiciones" maxlength="100" rows="2" placeholder="Área limitada a 100 caracteres."></textarea>
          </div>
        </div>
...
<script>
  ...
  $(document).ready(function () {
    ...
    $('#submit').on('click',function(){
      ...
      var condiciones =  $("#otras_condiciones").val();
      ...
      $.ajax({
        ...
        dataType: 'json',
        success:function (data) {
          window.location.href = '../cotizacion/'+folio;
          // redirect('./general/mantenimiento/'.folio);
        },
        error: function (data) {
          console.log('Error:', data);
          $('#btn-save').html('Guardar Cambios');
